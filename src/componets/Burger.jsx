  ...
  return (
    <div className='w-full my-6'>
        ...
        className='w-full my-12 overflow-x-scroll scrollbar-none  
            ...
            {
                burgers && burgers.map((burgerDetail)=>
                
                <div key={burgerDetail.id}
            ...
            border-gray-200 rounded-md flex justify-center items-center flex-col '>
                    ...
                    src={burgerDetail.imageURL}
                     alt={burgerDetail.title} 
                    
                     />
                    </div>
                    <div className='w-full flex justify-center items-center flex-col'>
                    <p className='text-lg font-semibold my-3'>{burgerDetail.title}</p>
                    <p className='text-base font-semibold my-3'>{burgerDetail.description}</p>
